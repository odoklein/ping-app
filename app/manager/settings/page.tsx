...
import {
  ...
  ListOrdered, Megaphone, Phone, Building2
} from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="elan-page">
        ...
        {/* Quick link: Mon Espace Agence & APIs Dédiées */}
        <Link
          href="/manager/settings/agency"
          className="group flex items-center gap-4 rounded-[12px] border border-primary/20 bg-primary/5 p-4 transition-colors hover:border-primary/50 hover:bg-primary/10"
        >
          <div className="flex h-10 w-10 items-center justify-center rounded-[10px] bg-primary/20 transition-colors group-hover:bg-primary/30 text-primary">
            <Building2 className="w-5 h-5" />
          </div>
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <p className="font-semibold text-slate-900 group-hover:text-primary">Mon Espace Agence &amp; APIs Dédiées</p>
              <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-primary/20 text-primary uppercase tracking-wider">
                Multi-Tenant
              </span>
            </div>
            <p className="text-sm text-slate-500">Configurez votre fournisseur VoIP (WithAllo, Ringover, Onoff), vos clés Leexi et votre serveur SMTP avec testeurs intégrés.</p>
          </div>
