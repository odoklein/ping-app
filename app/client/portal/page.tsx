                ...
                <div className="relative p-6 md:p-8">
                    ...
                    <div className="flex flex-col items-center md:items-start mb-8">
                        ...
                        <div className="mt-3 flex items-baseline gap-1">
                            ...
                            />
                            <span className="text-2xl font-bold text-slate-400 mb-2">RDV</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                        <div className="flex items-center gap-2">
                            <span className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Appels passés</span>
                            <div className="flex items-center rounded-lg bg-white/[0.08] border border-white/[0.06] p-0.5">
                                ...
                                <button
                                    ...
                                    className="w-8 h-8 rounded-md flex items-center justify-center text-slate-300 hover:bg-white/[0.12] hover:text-white transition-all disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent"
                        ...
                        <div className="flex items-center gap-3 rounded-xl bg-white/[0.08] backdrop-blur-sm border border-white/[0.06] px-4 py-3.5 hover:bg-white/[0.12] transition-all duration-200 group">
                            ...
                            <div>
                                ...
                                />
                                <p className="text-[11px] text-slate-400 mt-0.5 font-medium">ce mois</p>
                            </div>
                        </div>
                    </div>
                </div>
