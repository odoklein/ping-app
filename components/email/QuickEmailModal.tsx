        ...
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
            ...
            >
                ...
                {sentSuccess ? (
                    ...
                    <>
                        {/* Content */}
                        <div className="min-h-0 flex-1 overflow-y-auto p-6 space-y-5 email-scrollbar">
                            {/* Error */}
                            {error && (
                        ...
                        {/* Footer */}
                        <div className="flex-none flex items-center justify-between px-6 py-4 border-t border-slate-200 bg-slate-50">
                            <button
                                onClick={onClose}
