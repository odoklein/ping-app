                ...
                <div className="flex flex-col items-center gap-4">
                    <div className="relative">
                        <div className="w-14 h-14 rounded-xl bg-[#080808] flex items-center justify-center shadow-[0_10px_28px_rgba(0,0,0,0.18)]">
                            <Loader2 className="w-7 h-7 text-[var(--elan-amber)] animate-spin" />
                        </div>
                    </div>
            ...
            <div className={cn(containerHeight, "flex items-center justify-center bg-[#F5F7F6]", className)}>
                <div className="flex flex-col items-center gap-4 text-center p-8">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2.5 text-sm font-bold text-white bg-[var(--elan-amber)] hover:bg-[var(--elan-amber-deep)] rounded-lg transition-colors active:translate-y-px"
                    >
            ...
            <header className="h-[58px] flex-shrink-0 flex items-center gap-3 px-4 border-b border-[#DDE5E2] bg-white z-10">
                ...
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="flex items-center gap-2.5">
                        <div className="w-7 h-7 rounded-lg bg-[#080808] flex items-center justify-center shadow-sm">
                            <Image src="/brand/ping-logo-white.png" alt="" width={18} height={18} className="rounded object-contain" />
                        </div>
                    ...
                    {!selectedThread && (
                        <div className="flex-1 hidden lg:flex flex-col items-center justify-center bg-[#F5F7F6]">
                            <div className="w-16 h-16 rounded-xl bg-white border border-[#DDE5E2] flex items-center justify-center mb-4 shadow-sm">
                                <Image src="/brand/ping-logo-blue.png" alt="" width={36} height={36} className="rounded-lg object-contain opacity-60" />
                            </div>
