    ...
    return (
        <div className="w-full max-w-xl mx-auto mb-8">
            <div className="flex items-center justify-between relative">
                ...
                <div
                    className="absolute left-6 top-4 h-[2px] bg-gradient-to-r from-primary to-[#156cd4] transition-all duration-500 -z-0"
                    style={{
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <button
                            ...
                            className={cn(
                                ...
                                formData.type === "PERSONAL"
                                    ? "bg-blue-50/50 border-primary ring-2 ring-blue-500/10 shadow-sm"
                        ...
                        >
                            <div
                                className={cn(
                                    ...
                                    formData.type === "PERSONAL" ? "bg-primary text-white" : "bg-slate-100 text-slate-500"
                                )}
                            >
                        ...
                        >
                            <div
                                className={cn(
                                    "w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5",
                                    formData.type === "SHARED" ? "bg-primary text-white" : "bg-slate-100 text-slate-500"
                                )}
                            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="sm:col-span-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 bg-white text-slate-900 placeholder:text-slate-400 focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all text-sm font-medium"
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <input
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 bg-white text-slate-900 placeholder:text-slate-400 focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all text-sm"
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-3.5 py-2.5 pr-10 rounded-xl border border-slate-300 bg-white text-slate-900 placeholder:text-slate-400 focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all text-sm font-medium"
                                placeholder="••••••••••••"
                            />
                            <button
                                type="button"
                        ...
                        <div className="p-4 bg-white border-t border-slate-200 grid grid-cols-1 sm:grid-cols-2 gap-4 animate-in fade-in duration-150">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 rounded-lg border border-slate-300 bg-white text-slate-800 text-xs focus:border-primary outline-none"
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center gap-3">
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full sm:flex-1 py-3 px-6 rounded-xl bg-gradient-to-r from-primary to-[#156cd4] hover:from-[#1f7fe2] hover:to-[#0f5bb8] text-white font-bold text-sm shadow-md shadow-blue-500/25 transition-all flex items-center justify-center gap-2.5 active:scale-[0.99] disabled:opacity-60"
                >
                    {isLoading ? (
                        <>
            ...
            <div className="min-h-full flex items-center justify-center p-6 bg-[#F5F7F6]">
                <div className="w-full max-w-lg bg-white rounded-3xl p-8 border border-slate-200/80 shadow-xl shadow-slate-200/50 text-center animate-in zoom-in-95 fade-in duration-400">
                    ...
                    <button
                        ...
                        className="w-full py-3.5 px-6 rounded-xl bg-primary hover:bg-[#1f7fe2] text-white font-bold text-sm shadow-md shadow-blue-500/25 transition-all flex items-center justify-center gap-2"
                    >
                        <Loader2 className="w-4 h-4 animate-spin" />
        ...
        <div className="min-h-full py-10 px-4 sm:px-6 lg:px-8 bg-[#F5F7F6] overflow-y-auto">
            <div className="w-full max-w-4xl mx-auto space-y-10">
                ...
                <div className="text-center space-y-3 animate-in fade-in slide-in-from-bottom-2 duration-400">
                    <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 border border-blue-200/60 text-primary text-xs font-bold tracking-wide shadow-sm">
